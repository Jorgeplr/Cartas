module Api
  class GameController < ApplicationController
    ...
    # que esta vacio es el filtro: el jugador se quedaria mirando un boton
    # apagado sin saber que lo que tiene que tocar son las tematicas.
    def render_deck_empty
      if current_pairing.cards.in_deck.exists?
        render_error(:unprocessable_entity, "no_cards_in_theme",
                     "No quedan cartas de las tematicas elegidas")
      else
